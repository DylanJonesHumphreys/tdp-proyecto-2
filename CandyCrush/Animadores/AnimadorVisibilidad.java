...
public class AnimadorVisibilidad extends Thread implements Animador {
	...
	public AnimadorVisibilidad(ManejadorAnimaciones manager, Celda celda, int delay) {
		this.manager = manager;
		this.celda_animada = celda;
		this.delay = delay;
		this.debe_aparecer = celda.get_entidad_logica().get_visibilidad();
		/* path_imagen_destello = "/temas/clasico/imagenes/explosion/11.png"; */
		path_imagen_estado = celda.get_imagen_representativa();
		this.setName("Hilo animador de visibilidad");
	}
