...
public abstract class Entidad implements EntidadLogica, Intercambiable, Enfocable, Matchable, Detonable, Ocultable, DetonablePorAdyacencia{
	...
	protected void cargar_imagenes_representativas(String path_img) {
		...
		imagenes_representativas[2] = "/imagenes/explosion/11.png";//acomodar
	}
	...
	public Set<Entidad> get_entidades_alcanzadas_por_detonacion(Entidad[][] entidades) {
		Set<Entidad> entidades_alcanzadas_por_detonacion= new HashSet<Entidad>();
	...
	public void reposicionar_en_eje_z(){
		//Las entidades por defecto no se reposicionan
	}
