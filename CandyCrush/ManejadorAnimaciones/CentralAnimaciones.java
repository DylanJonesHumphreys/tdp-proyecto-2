...
import Animadores.AnimadorEstadoTdp2;
...
public class CentralAnimaciones implements ManejadorAnimaciones{
	...
	public void animar_intercambio(Celda celda) {
		Animador animador = new AnimadorMovimiento(this, 2, 4, celda);
	...
	public void animar_detonacion(Celda celda) {
		Animador animador = new AnimadorDetonacion(this, celda, 60);
		agregar_animador_y_lanzar_pendientes(animador);
	}
	
	public void animar_caida(Celda celda) {
		Animador animador = new AnimadorCaida(this, 2, 4, celda);
		agregar_animador_y_lanzar_pendientes(animador);
	}
	
	public void animar_cambio_visibilidad(Celda celda) {
		Animador animador = new AnimadorVisibilidad(this, celda, 10);
		agregar_animador_y_lanzar_pendientes(animador);
	}

	public void animar_cambio_estado_tdp2(Celda celda, int color) {
		Animador animador = new AnimadorEstadoTdp2(this, celda, color);
		agregar_animador_y_lanzar_pendientes(animador);
	}
