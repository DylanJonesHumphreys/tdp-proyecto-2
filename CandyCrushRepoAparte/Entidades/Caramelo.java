...
public class Caramelo extends Entidad {
	...
	public Caramelo(TableroEntidad tablero, int fila, int columna, int color) {
		super(tablero, fila, columna, color, "imagenes/caramelos/", true);
		puntajeEntidad=Puntaje.getPuntaje(color);
	}
	
	public Caramelo(TableroEntidad tablero, int fila, int columna, int color, boolean visible) {
		super(tablero, fila, columna, color, "imagenes/caramelos/", visible);
		puntajeEntidad=Puntaje.getPuntaje(color);
	}

	protected Caramelo(TableroEntidad tablero, int fila, int columna, int color, String path_imagenes, boolean visible) {
