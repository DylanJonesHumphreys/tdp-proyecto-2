...
public class Envuelto extends Potenciador {
	...
	public Envuelto(TableroEntidad tablero, int fila, int columna, int color) {
		super(tablero, fila, columna, color, "/imagenes/potenciadores/envueltos/", true);	
		puntajeEntidad=50;
	}
	public Envuelto(TableroEntidad tablero, int fila, int columna, int color, boolean visible){
