...
public class Gelatina extends Entidad {
	...
	public Gelatina(TableroEntidad tablero, Caramelo caramelo, int fila, int columna, int color) {
		super(tablero, fila, columna, color, "imagenes/gelatina/", true);
		caramelo_interno = caramelo;
		puntajeEntidad=10+caramelo_interno.getPuntajeEntidad();
	}
	
	public Gelatina(TableroEntidad tablero, Caramelo caramelo, int fila, int columna, int color, boolean visible) {
	...
	public int get_color() {
		return caramelo_interno.get_color();
	}
