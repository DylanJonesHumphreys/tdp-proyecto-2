...
public class Glaseado extends Entidad {
	...
	public Glaseado(TableroEntidad tablero, int fila, int columna, int color) {
		super(tablero, fila, columna, color, "imagenes/glaseados/", true);
		puntajeEntidad=25;
	}
	
	public Glaseado(TableroEntidad tablero, int fila, int columna, int color, boolean visible) {
