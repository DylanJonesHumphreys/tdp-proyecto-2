...
public class PotenciadorHorizontal extends Potenciador {
	...
	public PotenciadorHorizontal(TableroEntidad tablero, int fila, int columna, int color) {
		super(tablero, fila, columna, color, "/imagenes/potenciadores/rayados/horizontales/", true);
		puntajeEntidad=45;
	}
	
	public PotenciadorHorizontal(TableroEntidad tablero, int fila, int columna, int color, boolean visible) {
